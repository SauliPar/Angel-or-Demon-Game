  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.text}>
        {" "}
        So far you have chosen {userData.greenQuestion} angel options {"\n"} and{" "}
        {userData.redQuestion} demon options!
      </Text>
      <Text style={styles.text}>
        {" "}
        You have played{" "}
        {Number(userData.greenQuestion) + Number(userData.redQuestion)} days
        total.
      </Text>
    </View>
  );
